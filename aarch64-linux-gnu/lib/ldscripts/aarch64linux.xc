...
OUTPUT_ARCH(aarch64)
ENTRY(_start)
SEARCH_DIR("=/tmp/cirrus-ci-build/gcc-arm64gnu/aarch64-linux-gnu/lib64"); SEARCH_DIR("=/usr/local/lib64"); SEARCH_DIR("=/lib64"); SEARCH_DIR("=/usr/lib64"); SEARCH_DIR("=/tmp/cirrus-ci-build/gcc-arm64gnu/aarch64-linux-gnu/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
