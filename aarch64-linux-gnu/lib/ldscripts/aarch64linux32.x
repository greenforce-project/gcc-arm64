...
ENTRY(_start)
SEARCH_DIR("=/__w/gcc_build/gcc_build/gcc-arm64gnu/aarch64-linux-gnu/libilp32"); SEARCH_DIR("=/usr/local/libilp32"); SEARCH_DIR("=/libilp32"); SEARCH_DIR("=/usr/libilp32"); SEARCH_DIR("=/__w/gcc_build/gcc_build/gcc-arm64gnu/aarch64-linux-gnu/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
