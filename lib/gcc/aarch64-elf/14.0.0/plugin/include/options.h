...
enum opt_code
{
  ...
  OPT_mverbose_cost_dump = 1923,             /* -mverbose-cost-dump */
  OPT_n = 1924,                              /* -n */
  OPT_name_sort = 1925,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1926,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1927,              /* -no-integrated-cpp */
  OPT_no_pie = 1928,                         /* -no-pie */
  OPT_nocpp = 1929,                          /* -nocpp */
  OPT_nodefaultlibs = 1930,                  /* -nodefaultlibs */
  OPT_nolibc = 1931,                         /* -nolibc */
  OPT_nophoboslib = 1932,                    /* -nophoboslib */
  OPT_nostartfiles = 1933,                   /* -nostartfiles */
  OPT_nostdinc = 1934,                       /* -nostdinc */
  OPT_nostdinc__ = 1935,                     /* -nostdinc++ */
  OPT_nostdlib = 1936,                       /* -nostdlib */
  OPT_nostdlib__ = 1937,                     /* -nostdlib++ */
  OPT_o = 1938,                              /* -o */
  OPT_objects = 1939,                        /* -objects */
  OPT_p = 1940,                              /* -p */
  OPT_pass_exit_codes = 1941,                /* -pass-exit-codes */
  /* OPT_pedantic = 1942, */                 /* -pedantic */
  OPT_pedantic_errors = 1943,                /* -pedantic-errors */
  OPT_pg = 1944,                             /* -pg */
  OPT_pie = 1945,                            /* -pie */
  OPT_pipe = 1946,                           /* -pipe */
