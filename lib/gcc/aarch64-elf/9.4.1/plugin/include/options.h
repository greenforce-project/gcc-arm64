...
enum opt_code
{
  ...
  OPT_mharden_sls_ = 1283,                   /* -mharden-sls= */
  OPT_mlittle_endian = 1284,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1285,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1286,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1287,            /* -mlow-precision-sqrt */
  OPT_momit_leaf_frame_pointer = 1288,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1289,               /* -moutline-atomics */
  OPT_moverride_ = 1290,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1291,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1292,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1293, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1294,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1295,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1296,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1297,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1298,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1299,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1300,             /* -mtrack-speculation */
  OPT_mtune_ = 1301,                         /* -mtune= */
  OPT_mverbose_cost_dump = 1302,             /* -mverbose-cost-dump */
  OPT_n = 1303,                              /* -n */
  OPT_no_canonical_prefixes = 1304,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1305,              /* -no-integrated-cpp */
  OPT_no_pie = 1306,                         /* -no-pie */
  OPT_nocpp = 1307,                          /* -nocpp */
  OPT_nodefaultlibs = 1308,                  /* -nodefaultlibs */
  OPT_nolibc = 1309,                         /* -nolibc */
  OPT_nophoboslib = 1310,                    /* -nophoboslib */
  OPT_nostartfiles = 1311,                   /* -nostartfiles */
  OPT_nostdinc = 1312,                       /* -nostdinc */
  OPT_nostdinc__ = 1313,                     /* -nostdinc++ */
  OPT_nostdlib = 1314,                       /* -nostdlib */
  OPT_o = 1315,                              /* -o */
  OPT_p = 1316,                              /* -p */
  OPT_pass_exit_codes = 1317,                /* -pass-exit-codes */
  /* OPT_pedantic = 1318, */                 /* -pedantic */
  OPT_pedantic_errors = 1319,                /* -pedantic-errors */
  OPT_pg = 1320,                             /* -pg */
  OPT_pie = 1321,                            /* -pie */
  OPT_pipe = 1322,                           /* -pipe */
